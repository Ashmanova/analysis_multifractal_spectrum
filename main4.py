...
def calculate_multifractal_spectr(image, matrix_heldera, path_folder =""):
    ...
    for i, label in enumerate(unique_labels):
        if label!=0:
            ...
            fractal_dimensions[i+3] = frcatal_image.fractal_dim
...
if __name__ == '__main__':
    for i in range (1, 27):
        ...
        multifractal, lables = calculate_multifractal_spectr(small_image, matrix_heldera,path_mask + '/original/')
        ...
        for j in range(1,26):
            ...
            multifractal, lables = calculate_multifractal_spectr(small_image, matrix_heldera,
