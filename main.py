...
def projective_transformation (image_path, path_folder):
    ...
    np.savetxt(f'C:/Users/22354/PycharmProjects/Diplom_itog/result/norms_matrix3.txt', result, fmt='%.18e')
...
if __name__ == '__main__':
    for i in range (2, 3):
        ...
        # for j in range (1,26):
        #     print(j)
        #     path_image_transformed = f'C:/Users/22354/PycharmProjects/Diplom_itog/triangle/{i}/transformed_{j}.jpg'
        #     output_path = f'C:/Users/22354/PycharmProjects/Diplom_itog/triangle/{i}/data/matrix_heldera_trasformed_{j}'
        #     matrix_heldera_saved(path_image_transformed, output_path)
        #
        # path_image_transformed = f'C:/Users/22354/PycharmProjects/Diplom_itog/triangle/{i}/triangle_{i}.png'
        # output_path = f'C:/Users/22354/PycharmProjects/Diplom_itog/triangle/{i}/data/matrix_heldera_{i}'
        # matrix_heldera_saved(path_image_transformed, output_path)
        # #
        # # # Рассчитываем мультифрактальный спектр
        # result = np.empty((0, 10))
        # result2 = np.empty((0, 10))
        # matrix_heldera = np.loadtxt(f"C:/Users/22354/PycharmProjects/Diplom_itog/triangle/{i}/data/matrix_heldera_{i}")
        # path_mask = f"C:/Users/22354/PycharmProjects/Diplom_itog/triangle/{i}/mask"
        #
        ...
        #     gray_image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
        #     small_image = cv2.resize(gray_image, (64, 64))
        #     matrix_heldera = np.loadtxt(f"C:/Users/22354/PycharmProjects/Diplom_itog/triangle/{i}/data/matrix_heldera_trasformed_{j}")
        ...
        #
        # np.savetxt(f'C:/Users/22354/PycharmProjects/Diplom_itog/triangle/{i}/data/result_{i}', result, fmt='%.18e')
        # np.savetxt(f'C:/Users/22354/PycharmProjects/Diplom_itog/triangle/{i}/data/result_labls_{i}', result2, fmt='%.18e')
